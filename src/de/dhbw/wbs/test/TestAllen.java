...
public class TestAllen {
	...
	public void testEquals() {
		AllenRelation equalRelation = AllenRelation.getAllenRelation(span1, span1);
		assertRelationEquals(AllenRelation.EQUAL, equalRelation);
	}

	@Test
	public void testBefore() {
		AllenRelation beforeRelation = AllenRelation.getAllenRelation(span1, span4);
		assertRelationEquals(AllenRelation.BEFORE, beforeRelation);

		AllenRelation afterRelation = AllenRelation.getAllenRelation(span4, span1);
		assertRelationEquals(AllenRelation.AFTER, afterRelation);
	}

	@Test
	public void testStarts() {
		AllenRelation startsRelation = AllenRelation.getAllenRelation(span1, span2);
		assertRelationEquals(AllenRelation.STARTS, startsRelation);

		AllenRelation startsInvRelation = AllenRelation.getAllenRelation(span2, span1);
		assertRelationEquals(AllenRelation.STARTS_INV, startsInvRelation);
	}

	@Test
	public void testFinishes() {
		AllenRelation finishesRelation = AllenRelation.getAllenRelation(span4, span2);
		assertRelationEquals(AllenRelation.FINISHES, finishesRelation);

		AllenRelation finishesInvRelation = AllenRelation.getAllenRelation(span2, span4);
		assertRelationEquals(AllenRelation.FINISHES_INV, finishesInvRelation);
	}

	@Test
	public void testDuring() {
		AllenRelation duringRelation = AllenRelation.getAllenRelation(span3, span2);
		assertRelationEquals(AllenRelation.DURING, duringRelation);

		AllenRelation duringInvRelation = AllenRelation.getAllenRelation(span2, span3);
		assertRelationEquals(AllenRelation.DURING_INV, duringInvRelation);
	}

	@Test
	public void testOverlaps() {
		AllenRelation overlapsRelation = AllenRelation.getAllenRelation(span3, span4);
		assertRelationEquals(AllenRelation.OVERLAPS, overlapsRelation);

		AllenRelation overlapsInvRelation = AllenRelation.getAllenRelation(span4, span3);
		assertRelationEquals(AllenRelation.OVERLAPS_INV, overlapsInvRelation);
	}

	@Test
	public void testMeets() {
		AllenRelation meetsRelation = AllenRelation.getAllenRelation(span1, span3);
		assertRelationEquals(AllenRelation.MEETS, meetsRelation);

		AllenRelation meetsInvRelation = AllenRelation.getAllenRelation(span3, span1);
